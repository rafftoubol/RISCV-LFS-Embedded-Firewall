...
enum opt_code
{
  ...
  OPT_list = 1889,                           /* -list */
  OPT_mabi_ = 1890,                          /* -mabi= */
  OPT_malign_data_ = 1891,                   /* -malign-data= */
  OPT_march_ = 1892,                         /* -march= */
  OPT_mbig_endian = 1893,                    /* -mbig-endian */
  OPT_mbionic = 1894,                        /* -mbionic */
  OPT_mbranch_cost_ = 1895,                  /* -mbranch-cost= */
  OPT_mcmodel_ = 1896,                       /* -mcmodel= */
  OPT_mcpu_ = 1897,                          /* -mcpu= */
  OPT_mcsr_check = 1898,                     /* -mcsr-check */
  OPT_mdiv = 1899,                           /* -mdiv */
  OPT_mexplicit_relocs = 1900,               /* -mexplicit-relocs */
  OPT_mfdiv = 1901,                          /* -mfdiv */
  OPT_mglibc = 1902,                         /* -mglibc */
  OPT_minline_atomics = 1903,                /* -minline-atomics */
  OPT_misa_spec_ = 1904,                     /* -misa-spec= */
  OPT_mlittle_endian = 1905,                 /* -mlittle-endian */
  OPT_mmusl = 1906,                          /* -mmusl */
  OPT_mplt = 1907,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1908,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1909,                         /* -mrelax */
  OPT_mriscv_attribute = 1910,               /* -mriscv-attribute */
  OPT_msave_restore = 1911,                  /* -msave-restore */
  OPT_mshorten_memrefs = 1912,               /* -mshorten-memrefs */
  OPT_msmall_data_limit_ = 1913,             /* -msmall-data-limit= */
  ...
  OPT_mtune_ = 1918,                         /* -mtune= */
  OPT_muclibc = 1919,                        /* -muclibc */
  OPT_n = 1920,                              /* -n */
  OPT_name_sort = 1921,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1922,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1923,              /* -no-integrated-cpp */
  OPT_no_pie = 1924,                         /* -no-pie */
  OPT_nocpp = 1925,                          /* -nocpp */
  OPT_nodefaultlibs = 1926,                  /* -nodefaultlibs */
  OPT_nolibc = 1927,                         /* -nolibc */
  OPT_nophoboslib = 1928,                    /* -nophoboslib */
  OPT_nostartfiles = 1929,                   /* -nostartfiles */
  OPT_nostdinc = 1930,                       /* -nostdinc */
  OPT_nostdinc__ = 1931,                     /* -nostdinc++ */
  OPT_nostdlib = 1932,                       /* -nostdlib */
  OPT_nostdlib__ = 1933,                     /* -nostdlib++ */
  OPT_o = 1934,                              /* -o */
  OPT_objects = 1935,                        /* -objects */
  OPT_p = 1936,                              /* -p */
  OPT_pass_exit_codes = 1937,                /* -pass-exit-codes */
  /* OPT_pedantic = 1938, */                 /* -pedantic */
  OPT_pedantic_errors = 1939,                /* -pedantic-errors */
  OPT_pg = 1940,                             /* -pg */
  OPT_pie = 1941,                            /* -pie */
  OPT_pipe = 1942,                           /* -pipe */
  OPT_posix = 1943,                          /* -posix */
  OPT_print_file_name_ = 1944,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1945,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1946,          /* -print-multi-directory */
  OPT_print_multi_lib = 1947,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1948,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1949,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1950,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1951,               /* -print-prog-name= */
  OPT_print_search_dirs = 1952,              /* -print-search-dirs */
  OPT_print_sysroot = 1953,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1954,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1955,                    /* -print-value */
  OPT_profile = 1956,                        /* -profile */
  OPT_pthread = 1957,                        /* -pthread */
  OPT_quiet = 1958,                          /* -quiet */
  OPT_r = 1959,                              /* -r */
  OPT_rdynamic = 1960,                       /* -rdynamic */
  OPT_remap = 1961,                          /* -remap */
  OPT_reverse_sort = 1962,                   /* -reverse-sort */
  OPT_s = 1963,                              /* -s */
  OPT_save_temps = 1964,                     /* -save-temps */
  OPT_save_temps_ = 1965,                    /* -save-temps= */
  OPT_shared = 1966,                         /* -shared */
  OPT_shared_libgcc = 1967,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1968,               /* -shared-libphobos */
  OPT_size_sort = 1969,                      /* -size-sort */
  /* OPT_specs = 1970, */                    /* -specs */
  OPT_specs_ = 1971,                         /* -specs= */
  OPT_static = 1972,                         /* -static */
  OPT_static_libasan = 1973,                 /* -static-libasan */
  OPT_static_libgcc = 1974,                  /* -static-libgcc */
  OPT_static_libgfortran = 1975,             /* -static-libgfortran */
  OPT_static_libgm2 = 1976,                  /* -static-libgm2 */
  OPT_static_libgo = 1977,                   /* -static-libgo */
  OPT_static_libhwasan = 1978,               /* -static-libhwasan */
  OPT_static_liblsan = 1979,                 /* -static-liblsan */
  OPT_static_libmpx = 1980,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1981,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1982,               /* -static-libphobos */
  OPT_static_libquadmath = 1983,             /* -static-libquadmath */
  OPT_static_libstdc__ = 1984,               /* -static-libstdc++ */
  OPT_static_libtsan = 1985,                 /* -static-libtsan */
  OPT_static_libubsan = 1986,                /* -static-libubsan */
  OPT_static_pie = 1987,                     /* -static-pie */
  /* OPT_std_c__03 = 1988, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1989, */                /* -std=c++0x */
  OPT_std_c__11 = 1990,                      /* -std=c++11 */
  OPT_std_c__14 = 1991,                      /* -std=c++14 */
  OPT_std_c__17 = 1992,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1993, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1994, */                /* -std=c++1z */
  OPT_std_c__20 = 1995,                      /* -std=c++20 */
  OPT_std_c__23 = 1996,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1997, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1998, */                /* -std=c++2b */
  OPT_std_c__98 = 1999,                      /* -std=c++98 */
  OPT_std_c11 = 2000,                        /* -std=c11 */
  OPT_std_c17 = 2001,                        /* -std=c17 */
  /* OPT_std_c18 = 2002, */                  /* -std=c18 */
  /* OPT_std_c1x = 2003, */                  /* -std=c1x */
  OPT_std_c2x = 2004,                        /* -std=c2x */
  /* OPT_std_c89 = 2005, */                  /* -std=c89 */
  OPT_std_c90 = 2006,                        /* -std=c90 */
  OPT_std_c99 = 2007,                        /* -std=c99 */
  /* OPT_std_c9x = 2008, */                  /* -std=c9x */
  OPT_std_f2003 = 2009,                      /* -std=f2003 */
  OPT_std_f2008 = 2010,                      /* -std=f2008 */
  OPT_std_f2008ts = 2011,                    /* -std=f2008ts */
  OPT_std_f2018 = 2012,                      /* -std=f2018 */
  OPT_std_f95 = 2013,                        /* -std=f95 */
  OPT_std_gnu = 2014,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2015, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2016, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2017,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2018,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2019,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2020, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2021, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2022,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2023,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 2024, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2025, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 2026,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2027,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2028,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2029, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2030, */                /* -std=gnu1x */
  OPT_std_gnu2x = 2031,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 2032, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2033,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2034,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2035, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2036, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2037,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2038, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2039, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2040, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2041, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2042, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 2043,                     /* -std=legacy */
  OPT_stdlib_ = 2044,                        /* -stdlib= */
  OPT_symbol_ = 2045,                        /* -symbol= */
  OPT_symbolic = 2046,                       /* -symbolic */
  OPT_t = 2047,                              /* -t */
  OPT_time = 2048,                           /* -time */
  OPT_time_ = 2049,                          /* -time= */
  OPT_traditional = 2050,                    /* -traditional */
  OPT_traditional_cpp = 2051,                /* -traditional-cpp */
  OPT_tree_stats = 2052,                     /* -tree-stats */
  OPT_trigraphs = 2053,                      /* -trigraphs */
  OPT_type_stats = 2054,                     /* -type-stats */
  OPT_u = 2055,                              /* -u */
  OPT_undef = 2056,                          /* -undef */
  OPT_v = 2057,                              /* -v */
  OPT_version = 2058,                        /* -version */
  OPT_w = 2059,                              /* -w */
  OPT_wrapper = 2060,                        /* -wrapper */
  OPT_x = 2061,                              /* -x */
  OPT_z = 2062,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
